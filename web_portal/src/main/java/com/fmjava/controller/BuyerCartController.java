...
import com.fmjava.service.CartService;
import com.fmjava.utils.Constants;
import com.fmjava.utils.CookieUtil;
...
public class BuyerCartController {
    ...
    public List<BuyerCart> findCartList(HttpServletRequest request, HttpServletResponse response){
        ...
        if ("null".equals(cookieCartListStr) || "".equals(cookieCartListStr) || cookieCartListStr==null) {
            cookieCartListStr = "[]";
        }
        //4. 将购物车列表json转换为对象
